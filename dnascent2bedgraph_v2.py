...
# With changes by Conrad A. Nieduszynski (conrad.nieduszynski@earlham.ac.uk)
			...
			if not first:
				...
				if rLen > args.minLength and rLen < args.maxLength:
					...
					if fname[1] == "detect":
						...
						f_bg.write( 'track type=bedGraph name="'+readID +strand +'" description="BedGraph format" visibility=full color=200,100,0 altColor=0,100,200 priority=20 viewLimits=0.0:1.0'+'\n')
